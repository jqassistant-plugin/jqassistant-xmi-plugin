...
All UML elements described below, including the <<UMLModel>>, itself are <<XMIElement>>s.
...
| xmiType  | The type of the XMI element, i.e. `uml:Model`.
| name     | The name of the XMI element.
|===
