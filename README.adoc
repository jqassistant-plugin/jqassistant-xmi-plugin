...
This section describes how a UML model can be used to...

* define the building blocks of a system using UML components and their allowed dependencies
* map the UML structures to a code base
* verify the current code structure to conform the UML model
