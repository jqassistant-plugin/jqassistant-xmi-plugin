...
Download the shaded JAR file from https://search.maven.org/artifact/org.jqassistant.contrib.plugin/jqassistant-uml-plugin[Maven Central] and put it into the `/plugins` folder of the distribution.
