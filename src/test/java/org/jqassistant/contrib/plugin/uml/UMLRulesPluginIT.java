...
class UMLRulesPluginIT extends AbstractUMLPluginIT {
     ...
     */
    @Test
    void umlDefault() throws RuleException {
        executeGroup("xmi:UMLDefault");
        List<String> conceptIds = query("MATCH (concept:Concept) RETURN concept.id as id").getColumn("id");
        assertThat(conceptIds).containsExactlyInAnyOrder("xmi:UMLPackage", "xmi:UMLComponent", "xmi:UMLProperty", "xmi:UMLPort", "xmi:UMLAssociation", "xmi:UMLDependency", "xmi:UMLUsage", "xmi:UMLProvidesInterface", "xmi:UMLRequiresInterface");
    }
}
