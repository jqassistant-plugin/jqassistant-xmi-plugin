...
import org.jqassistant.plugin.xmi.api.UMLOwnedAttributeDescriptor;
import org.jqassistant.plugin.xmi.api.UMLPackagedElementDescriptor;
...
class UMLRulesPluginIT extends AbstractUMLPluginIT {
    ...
    void umlPackage() throws RuleException {
        ...
        assertThat(rows.get(0).getColumns().get("Packages").getValue()).isEqualTo(5L);
    ...
    void umlComponent() throws RuleException {
        ...
        List<Row> rows = result.getRows();
        assertThat(rows).hasSize(1);
        assertThat(rows.get(0).getColumns().get("Components").getValue()).isEqualTo(7L);
    ...
    void umlProperty() throws RuleException {
        ...
        List<Row> rows = result.getRows();
        assertThat(rows).hasSize(1);
        assertThat(rows.get(0).getColumns().get("Properties").getValue()).isEqualTo(4L);
    ...
    void umlPort() throws RuleException {
        ...
        List<Row> rows = result.getRows();
        assertThat(rows).hasSize(1);
        assertThat(rows.get(0).getColumns().get("Ports").getValue()).isEqualTo(2L);
    ...
    void umlAssociation() throws RuleException {
        ...
        List<Row> rows = result.getRows();
        assertThat(rows).hasSize(1);
        assertThat(rows.get(0).getColumns().get("Associations").getValue()).isEqualTo(2L);
    ...
    void umlDependency() throws RuleException {
        ...
        List<Row> rows = result.getRows();
        assertThat(rows).hasSize(1);
        assertThat(rows.get(0).getColumns().get("Dependencies").getValue()).isEqualTo(1L);
    ...
    void umlUsage() throws RuleException {
        ...
        List<Row> rows = result.getRows();
        assertThat(rows).hasSize(1);
        assertThat(rows.get(0).getColumns().get("Usages").getValue()).isEqualTo(1L);
    ...
    void umlInformationFlow() throws RuleException {
        ...
        List<Row> rows = result.getRows();
        assertThat(rows).hasSize(1);
        assertThat(rows.get(0).getColumns().get("InformationFlows").getValue()).isEqualTo(1L);
    ...
    void umlProvidesInterface() throws RuleException {
        ...
        List<Row> rows = result.getRows();
        assertThat(rows).hasSize(1);
        assertThat(rows.get(0).getColumns().get("ProvidesInterfaces").getValue()).isEqualTo(2L);
    ...
    void umlRequiresInterface() throws RuleException {
        ...
        List<Row> rows = result.getRows();
        assertThat(rows).hasSize(1);
        assertThat(rows.get(0).getColumns().get("RequiresInterfaces").getValue()).isEqualTo(2L);
